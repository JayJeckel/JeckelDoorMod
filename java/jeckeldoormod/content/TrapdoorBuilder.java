...
import jeckeldoormod.content.blocks.BlockModTrapDoor;
...
public class TrapdoorBuilder
{
	...
	public static ContentData createWood(final String name, final int meta)
	{
		...
		content.addRecipe(recipeBasic(new ItemStack(content.block, 2), new ItemStack(Blocks.planks, 1, meta + 1)));
		return content;
	}
	...
	public static ContentData createColoredMixed(final String name, final int meta)
	{
		...
		final IRecipe recipe = new ShapedOreRecipe(new ItemStack(content.block, 2),
				" % ",
				"#?#",
				"???",
	...
	public static ContentData createColoredSolid(final String name, final int meta)
	{
		...
		content.addRecipe(recipeColored(new ItemStack(content.block, 2), "plankWood", new ItemStack(Items.dye, 1, meta)));
		return content;
	}
	...
	public static ContentData createColoredGlass(final String name, final int meta)
	{
		...
		content.addRecipe(recipeColored(new ItemStack(content.block, 2), new ItemStack(Blocks.glass), new ItemStack(Items.dye, 1, meta)));
		content.addRecipe(recipeBasic(new ItemStack(content.block, 2), new ItemStack(Blocks.stained_glass, 1, meta)));
		return content;
	}

	private static ContentData create(final String name, final String folder, final boolean transparency)
	{
		BlockModTrapDoor block = new BlockModTrapDoor(Material.wood);
		...
		return new ContentData(block, null);
	}
